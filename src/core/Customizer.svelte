<script>
  ...
  function checkplayers(){
    if (config.players.length == 128 ||config.players.length == 64 ||config.players.length == 4 || config.players.length == 8|| config.players.length == 16|| config.players.length == 32){
      playerAmountOk = true
    }else{
