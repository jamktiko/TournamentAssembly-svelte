...
<div id="container">
  <div class="modal">
    <div class="winner-content">
      <h1 class="tournament-name">{config.tournamentName}</h1>
      <h2>Winner</h2>
...
<style>
  ...
  @keyframes pulse {
    0% {
      filter: brightness(1) drop-shadow(0 0 30px rgb(255, 255, 255));
    }
    50% {
      filter: brightness(2.5) drop-shadow(0 0 30px rgb(99, 115, 255));
    }
    100% {
      filter: brightness(1) drop-shadow(0 0 30px rgb(255, 255, 255));
    }
